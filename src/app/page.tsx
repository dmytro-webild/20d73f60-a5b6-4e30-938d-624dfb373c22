...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      slides={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/vertical-shot-mandola-wooden-table-with-wooden-wall_181624-21686.jpg",
          imageAlt: "Joanie's bar interior",
        },
        {
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/full-shot-teenagers-sitting-together_23-2149241598.jpg",
          imageAlt: "Joanie's bar interior",
        },
      ]}
    />
      ...
      bulletPoints={[
        {
          ...
          description: "Classic dive bar vibes with a friendly, welcoming crowd.",
        },
        {
          title: "Top-Notch Service",
          description: "Our bartenders make everyone feel like a regular.",
        },
        {
          title: "Pool & Tunes",
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Pool Tables",
          description: "Classic fun with friends.",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        {
          id: "4",
          name: "Tiffany Huertas",
          imageSrc: "http://img.b2bpic.net/free-photo/person-enjoying-their-time-dj-party_23-2149658378.jpg",
        },
        {
          id: "5",
          name: "Jess Flores",
          imageSrc: "http://img.b2bpic.net/free-photo/couple-relaxing-pub-eating-pizza-they-are-laughing-eating-pizza_482257-18663.jpg",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "Is the bar cash only?",
          content: "Yes, we are a cash-only establishment with an ATM on-site.",
        },
        {
          id: "q2",
          title: "Do you serve food?",
          content: "We don't have a kitchen, but you can often find local BBQ pop-ups outside on weekends.",
        },
        {
          id: "q3",
          title: "Are you pet friendly?",
          content: "Please check with our staff during your visit!",
        },
      ]}
